    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-primary-light rounded-lg shadow-md p-6 mb-6">
        <div className="flex items-center space-x-4">
          ...
          />
          <div>
            <h1 className="text-2xl font-bold text-gray-dark">Welcome back, Aditya!</h1>
            <p className="text-gray-text">Web Developer | Gamer | Photography Enthusiast</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-4">
              {activities.map((activity, index) => (
                <div key={index} className="flex items-start space-x-3 p-3 hover:bg-gray-light rounded-lg">
                  ...
                  <div>
                    ...
                    <span className="text-xs text-gray-text">{activity.time}</span>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="col-span-1">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-semibold mb-4 text-primary">Suggested Matches</h2>
            <div className="space-y-4">
              {suggestedMatches.map((match, index) => (
                <div key={index} className="flex items-start space-x-3 p-3 hover:bg-gray-light rounded-lg">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-text">{match.branch} • {match.year}</p>
